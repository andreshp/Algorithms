...
El problema a resolver se encuentra en [Hackerrank](https://www.hackerrank.com/contests/infinitum9/challenges/fibonacci-gcd). Se muestra a continuación una versión traducida del mismo.
...
1 & 0
\end{pmatrix}$$.
La exponenciación de matrices se puede conseguir logarítmica de forma análoga a la exponenciación (con exponente natural) de un número. El **Algoritmo 2** muestra un pseudo-código recursivo para este propósito.
